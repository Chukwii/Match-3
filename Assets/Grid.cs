...
public class Grid : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        for(int i = 0; i < initialPieces.Length; i++)
        {
            if(initialPieces[i].x >= 0 && initialPieces[i].x < xDim
                && initialPieces[i].y >= 0 && initialPieces[i].y < xDim)
            {
    ...
    void Update()
    {
        ...
        {
            GamePiece piece1; GamePiece piece2;
        ...
        for(int y = yDim - 2; y >= 0; y--)
        {
            for(int loopX = 0; loopX < xDim; loopX++)
            {
                ...
                if (piece.IsMovable())
                {
                    ...
                    GameObject.FindObjectOfType<soundController>().playLandClip();
    ...
    {
        return new Vector2(transform.position.x - xDim / 2.25f + x, transform.position.y + yDim / 2.25f - y);
    }
    ...
    public void SwapPieces(GamePiece piece1, GamePiece piece2)
    {
        ...
        {
            GameObject.FindObjectOfType<soundController>().playSwipeClip();
            pieces[piece1.X, piece1.Y] = piece2;
            pieces[piece2.X, piece2.Y] = piece1;
               ...
               || piece1.Type == PieceType.RAINBOW || piece2.Type == PieceType.RAINBOW)
            {
                ...
                piece2.MovableComponent.Move(piecce1X, piece1Y, fillTime);
    ...
    public List<GamePiece> GetMatch(GamePiece piece, int newX, int newY)
    {
        if (piece.IsColored())
        {
            ...
            // Traverse vertically if we found a match (for L and T shap)
            if(horizontalPieces.Count >= 3)
            {
                for(int i = 0; i < horizontalPieces.Count; i++)
                {
            ...
            // Didn't find anything going horizontallt first
            ...
            // Traverse horizontally if we found a match (for L and T shap)
            if (verticalPieces.Count >= 3)
            {
                for (int i = 0; i < verticalPieces.Count; i++)
                {
